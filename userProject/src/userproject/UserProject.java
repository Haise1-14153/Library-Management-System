...
public class UserProject extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        defaultBackground.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/mainbackground.png"))); // NOI18N
            ...
            .addGroup(createAccInterfaceLayout.createSequentialGroup()
                ...
                .addGroup(createAccInterfaceLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(createAccInterfaceLayout.createSequentialGroup()
                        ...
                        .addGap(112, 112, 112))
                    .addGroup(createAccInterfaceLayout.createSequentialGroup()
                        .addGroup(createAccInterfaceLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        String stringid = jTextField10.getText();
        ...
        if(user.equals("") || pass.equals("") || fname.equals("") || lname.equals("")) {
            ...
            try {
                int checkInput = Integer.parseInt(stringid);
                ...
                JOptionPane.showMessageDialog(null,"Invalid Student ID","Error message",JOptionPane.ERROR_MESSAGE);
            }
        }
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        ...
        try {
            ...
            if(myObj.compareCode(user,code)) {
                ...
                myObj.createAccount(user,pass,fname,lname,bmon,bday,byear,gender,id,dateCreated);
    ...
    private void loggingInCall() {             
        ...
        if(myObj.loggingIn(user,pass,name)) {
            dispose();
            MainInterface run = new MainInterface(user,name,Integer.parseInt(name[2]));
            run.MainInterface();
        }
        else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UserProject.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new UserProject().setVisible(true);
        });
