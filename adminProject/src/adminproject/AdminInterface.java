...
public class AdminInterface extends javax.swing.JFrame implements ActionListener {
    ...
    private void initComponents() {
        ...
        createStaffAccount = new javax.swing.JPanel();
        ...
        codeverification = new javax.swing.JPanel();
        ...
        jButton19.setFont(new java.awt.Font("Segoe UI", 1, 19)); // NOI18N
        jButton19.setForeground(new java.awt.Color(255, 255, 255));
        jButton19.setText("Create Staff Account");
        ...
        jLabel3.setText("International Standard Book Number (ISBN)");
        ...
        jLabel39.setText("Maximum days of borrowing");
        ...
        createStaffAccount.setBackground(new java.awt.Color(255, 255, 255));
        createStaffAccount.setPreferredSize(new java.awt.Dimension(1016, 768));

        jLabel72.setFont(new java.awt.Font("Segoe UI", 1, 48)); // NOI18N
        jLabel72.setText("Create Staff Account");
        ...
        choice2.setPreferredSize(new java.awt.Dimension(28, 28));
        ...
        choice6.setFont(new java.awt.Font("Dialog", 0, 20)); // NOI18N
        ...
        choice7.setFont(new java.awt.Font("Dialog", 0, 20)); // NOI18N

        choice4.insert("Male",1);
        choice4.insert("Female",2);
        choice4.setFocusable(false);
        choice4.setFont(new java.awt.Font("Dialog", 0, 20)); // NOI18N
        ...
        jLabel44.setText("Note: The email will be the username.");
        ...
        javax.swing.GroupLayout createStaffAccountLayout = new javax.swing.GroupLayout(createStaffAccount);
        createStaffAccount.setLayout(createStaffAccountLayout);
        createStaffAccountLayout.setHorizontalGroup(
            createStaffAccountLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(createStaffAccountLayout.createSequentialGroup()
                .addGroup(createStaffAccountLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(createStaffAccountLayout.createSequentialGroup()
                        .addGap(68, 68, 68)
                    ...
                    .addGroup(createStaffAccountLayout.createSequentialGroup()
                        ...
                        .addGroup(createStaffAccountLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(createStaffAccountLayout.createSequentialGroup()
                                .addGroup(createStaffAccountLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    ...
                                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, createStaffAccountLayout.createSequentialGroup()
                                        .addGroup(createStaffAccountLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        createStaffAccountLayout.setVerticalGroup(
            createStaffAccountLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(createStaffAccountLayout.createSequentialGroup()
                .addGap(99, 99, 99)
                .addComponent(jLabel72)
                ...
                .addComponent(jPanel22, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(createStaffAccountLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel30)
                    .addComponent(jLabel33))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(createStaffAccountLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        parent.add(createStaffAccount, "card13");

        codeverification.setBackground(new java.awt.Color(255, 255, 255));
        codeverification.setPreferredSize(new java.awt.Dimension(1016, 768));

        jLabel53.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel53.setText("Enter 6-digit code");
        ...
        jLabel58.setText("Verification");

        javax.swing.GroupLayout codeverificationLayout = new javax.swing.GroupLayout(codeverification);
        codeverification.setLayout(codeverificationLayout);
        codeverificationLayout.setHorizontalGroup(
            codeverificationLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(codeverificationLayout.createSequentialGroup()
                .addGroup(codeverificationLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(codeverificationLayout.createSequentialGroup()
                        .addGap(68, 68, 68)
        ...
        codeverificationLayout.setVerticalGroup(
            codeverificationLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(codeverificationLayout.createSequentialGroup()
                .addGap(93, 93, 93)
                ...
                .addComponent(jLabel54)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(codeverificationLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        parent.add(codeverification, "card2");
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        if(JOptionPane.showConfirmDialog(null,"Save changes?","Confirmation",JOptionPane.OK_CANCEL_OPTION) == JOptionPane.OK_OPTION) {
            ...
            run.saveInfo(base,jTextField12.getText(),jTextField20.getText());
    ...
    private void jButton18ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton18ActionPerformed
        ...
        if(!(newPass.equals("") || confirmNewPass.equals(""))) {
            if(newPass.equals(confirmNewPass)) {
                adminloginClass run1 = new adminloginClass();
    ...
    private void jButton19ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton19ActionPerformed
        changepanel(parent,createStaffAccount);
    }//GEN-LAST:event_jButton19ActionPerformed

    private void jButton22ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton22ActionPerformed
        String user = jTextField9.getText();
        ...
        if(user.equals("") || pass.equals("") || fname.equals("") || lname.equals("")) {
            ...
            adminloginClass run1 = new adminloginClass();
            if(run1.checkDuplicateEmail(user)) {
                if(isValidEmailAddress(user)) {
                    if(run1.setCode(USERNAME,"Your code for creating Staff Account is ")) {
                        jLabel29.setVisible(false);
                        changepanel(parent,codeverification);
                    }
                }
                else {
                    jTextField9.setText("");
    ...
    private void jButton29ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton29ActionPerformed
        erase(choice2,choice4,choice6,choice7,jTextField3,jTextField4,jTextField9,jTextField10);
    ...
    private void jButton30ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton30ActionPerformed
        adminloginClass run1 = new adminloginClass();
        run1.setCode(USERNAME,"Your code for creating Staff Account is ");
    ...
    private void jButton31ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton31ActionPerformed
        ...
        String gender = choice4.getItem(choice4.getSelectedIndex());
        adminloginClass run1 = new adminloginClass();
        String strCode = jTextField18.getText();
        int code;
        try {
            code = Integer.parseInt(strCode);
            if(run1.compareCode(USERNAME,code)) {
                String dateCreated = month[date[1]]+" "+date[2]+" "+date[0];
                run1.createStaffAccount(user,pass,fname,lname,bmon,bday,byear,gender,dateCreated);
                erase(choice2,choice4,choice6,choice7,jTextField3,jTextField4,jTextField9,jTextField10);
                changepanel(parent,createStaffAccount);
    ...
    private String getAdminInfo(JTable a) {
        try {
            ...
            conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/admindatabase","root","root");
            //get count
            String cmd = "select count(*) from accountInfo where account_type = 1";
            prestmt = conn.prepareStatement(cmd);
            ...
            //show in tables
            cmd = "select * from accountInfo where account_type = 1 order by datecreated asc";
            prestmt = conn.prepareStatement(cmd);
            result = prestmt.executeQuery();
            while(result.next()) {
    ...
    private String getStaffInfo(JTable a) {
        try {
            ...
            conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/admindatabase","root","root");
            //get count
            String cmd = "select count(*) from accountInfo where account_type = 0";
            prestmt = conn.prepareStatement(cmd);
            result = prestmt.executeQuery();
            result.next();
            int count = result.getInt(1);
            ...
            //show in tables
            cmd =  "select * from accountInfo where account_type = 0 order by datecreated asc";
            prestmt = conn.prepareStatement(cmd);
            result = prestmt.executeQuery();
            while(result.next()) {
                table.addRow(new Object[]{result.getString("username"),result.getString("firstname")+" "+result.getString("lastname"),result.getString("gender"),result.getString("datecreated")});
    ...
    public void unlistBookSearchMethod(JTextField a, JTable b) {
        ...
        try {
            Class.forName("com.mysql.cj.jdbc.Driver");
            conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/admindatabase","root","root");
            String cmd = "select * from bookInformation WHERE Book_Name LIKE \""+ text +"%\" or Author LIKE \""+ text +"%\" ORDER BY book_name ASC, book_number asc";
            prestmt = conn.prepareStatement(cmd);
            ...
            while(result.next()) {
                String slot1 = "("+result.getInt("Book_Number")+")"+result.getString("Book_Name");
                 table.addRow(new Object[]{result.getInt("BookID"),slot1,result.getString("Author")});
            }
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(AdminProject.class.getName()).log(Level.SEVERE, null, ex);
        } catch (SQLException ex) {
    ...
    private javax.swing.JPanel codeverification;
    private javax.swing.JPanel createStaffAccount;
